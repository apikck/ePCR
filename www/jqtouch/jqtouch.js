...
(function($) {
    $.jQTouch = function(options) {
        ...
        var defaults = {
            ...
            preloadImages: false,
            startupScreen: '../epcr-startup.png',
        ...
        function addPageToHistory(page, search, pageback, animation) {
            ...
            var section = splitscreenmode? npage.prop('section'): defaultSection;
        ...
        */
        function animatePages(params) {
            ...
            var main = toPage.prop('section') === defaultSection;
        ...
        function goTo(param, p2, p3) {
            ...
            var section = toPage.prop('section');
              ...
              return false;
                ...
                var animationstarted = animatePages({
                    ...
                    pagecallback: function() {
                        ...
                        toPage.trigger('pagein', {hash: '#' + toPage.prop('id'), search: param.search});
                    }
                });
                if (animationstarted) {
        ...
        function insertPages(nodes, animation) {
            ...
            $(nodes).each(function(index, node) {
                ...
                var section = $node.prop('section');
                if (!section) {
                    $node.prop('section', defaultSection);
                }
        ...
        */
        ...
        function clickHandler(e) {
			...
			if(allowClick == false) return false;
			preventGhostClick();
                ...
                if (hash && hash !== '#' && !$el.isExternalLink()) {
                    ...
                    if ($el.is(jQTSettings.dialogSelector) || $el.find(jQTSettings.dialogSelector).length > 0) {
                      pageback = function(returns) {
                        ...
                        if (returns) {
                          for (var i=0, len=returns.length; i<len; i++) {
                            ...
                            console.warn("setting value for item: " + $item.prop("id"));
                            $item.val(item.value);
                      ...
                      $el.find('input[data-sourcename]').each(function(i, input) {
                        var $input = $(input);
                        var name = $input.prop('data-sourcename');
                        if (name) {
        ...
        $(document).ready(function() {
            ...
            if (splitscreenmode) {
                ...
                defaultSection = "main";
                $('#jqt > [section!="aside"]').prop("section", defaultSection);
            } else {
                defaultSection = "full";
                $('#jqt > *').prop("section", defaultSection);
            }
